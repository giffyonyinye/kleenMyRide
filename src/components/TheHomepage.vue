    ...
    <div>
        <div class=" flex justify-around pt-28 md:flex-col">
            ...
            <div class=" md:m-auto ">
                ...
                <div class=" pt-8">
                    <button class=" border border-yellow-700 w-34 p-2 rounded-lg">Learn More</button>
                    <button class="ml-6 bg-yellow-700  text-white w-34 p-2 rounded-lg">Book Now</button>
                </div>
            </div>
            <div>
                <img class=" md:w-full" src="../assets/Images/carwash.png" alt="">
            </div>
        </div>

        <div class="  pt-4 md:p-8">
            <div class=" mt-10">
                <p class=" text-center text-yellow-700 text-xl">About Us</p>
                <p class=" text-center border-2 border-yellow-700 w-20 m-auto"></p>
            </div>

            <div class=" flex justify-center mt-8 md:flex-col-reverse">
                <div>
                    <!-- <img class=" w-80" src="../assets/Images/carwash3.jpg" alt=""> -->
                ...
                <div class="md:bg-gray-200 ml-40 md:w-full md:m-auto md:p-8"> 
                    ...
                    <p class="w-96 mt-8 md:w-full">Kleen my ride is specialist in car washing field. We offer car 
                        ...
                        We offer car washing services right at your doorstep with fully
                    ...
                    <p class=" border w-1/3 text-center p-2 border-yellow-700 rounded-lg mt-4">Learn More </p>
                </div>
            </div>
        </div>
        ...
        <div class="  flex justify-around mt-20 md:flex-col-reverse">
            ...
            <div>
                ...
                <div class=" mt-4">
                    ...
                    <p class=" text-5xl mt-4 text-center text-yellow-700 drop-shadow-lg">300+</p>
                </div>
            </div>
        </div> 
        ...
        <section class=" mt-20">
            ...
            <div>
                <h4 class=" text-center text-yellow-700">OUR EQUIPMENT</h4>
                <p class=" text-center">We specialise in cleaning your car with fully car washing equipments and handwash. Our equipments ranges from;</p>
                <div class=" flex justify-around mt-8">
                    <div class="flex md:flex-col" >
                        <div class=" flex w-60 bg-yellow-500 p-4 shadow-2xl mr-10 rounded-2xl">
                            <SparklesIcon class=" h-6 w-6 mr-2"/>
                            <div>
                                <p class=" font-medium">Car washing system</p>
                                <p>convey or tunnel or self service wands.</p>
                            </div>
                        </div>
                        <div class="flex w-60 mt-6 bg-yellow-400 p-4 shadow-2xl mr-10 rounded-2xl">
                            <SparklesIcon class=" h-6 w-6 mr-2"/>
                            <div>
                                <p class=" font-medium">Chemicals</p>
                                <p>cleaning and spot-free solution.</p>
                            </div>
                        </div>

                        <div class="flex w-60 mt-10 bg-yellow-300 p-4 rounded-2xl">
                            <SparklesIcon class=" h-6 w-6 mr-2"/>
                            <div>
                                <p class=" font-medium">More equipments</p>
                                <p>Dryers, blowers, vacuum, brushes, towels, water system, payment processing system.</p>
                            </div>
                        </div>
                    </div>
        ...
        <div>
             <div class=" text-center mt-32 bg-gray-200 pt-8 pb-8">
                ...
                <p class="w-1/2 m-auto pt-4 md:w-full md:p-2">Kleen my ride washing employees are highly professional and trained car washers. Our staff has excellent
                    ...
                    and we believe that they are the key to healthy and successful business establishment. We recruited the most professional 
                    and qualified workforce available. The company success has been built on the dedication and skills of its staff.
                    We always consider improving and developing our human resource as top priority. This enables us to provide the good services to
                    our customers.
                </p>
                <p class=" border w-1/12 m-auto text-center p-2 border-yellow-700 rounded-lg mt-4 md:w-1/3">Learn More </p>
